...
//        InterfaceForGenerics.
//        Менять можно только класс Solution.
//
//
//        Requirements:
//        1. Класс Solution должен быть параметризирован типом который является наследником класса
//        ClassForGenerics и одновременно реализовывать интерфейс InterfaceForGenerics.
