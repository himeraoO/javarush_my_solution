...
import com.fasterxml.jackson.annotation.JsonAutoDetect;//надо исправить
import com.fasterxml.jackson.databind.ObjectMapper;//надо исправить
...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        convertToJSON(writer, pets);//надо исправить
